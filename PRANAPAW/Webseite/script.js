(() => {
  ...
  const legalPages = {
    agb: {
      ...
      html: `
        ...
        <p>Diese Allgemeinen Geschäftsbedingungen gelten für alle Vereinbarungen über energetische Begleitung, Prana Fernheilung und Tierkommunikation zwischen</p>
        <p><strong>Kevin Maus · pranapaw · Theoderichstraße 38 · 42281 Wuppertal</strong> (nachfolgend „Anbieter") und Klientinnen und Klienten (nachfolgend „Klient·in").</p>

        <h3>2. Leistungsbeschreibung &amp; Vergütung</h3>
        <p>Der Anbieter erbringt energetische Begleitung, Prana Fernheilung und Tierkommunikation auf der Grundlage individueller Vereinbarungen.</p>
        <p><strong>Standardtarif:</strong> 1,00 € pro Minute (Abrechnung in Minutenschritten, Mindestdauer 30 Minuten).</p>
        <p><strong>Förderliche Dienste statt Geldvergütung:</strong> Sitzungsminuten können auch durch folgende gemeinschaftliche Leistungen zugunsten von pranapaw erarbeitet werden:</p>
        <ul>
          <li>⭐ Verifizierte Google-Bewertung (5 Sterne mit Text) → bis zu 15 Freiminuten</li>
          <li>📢 Öffentliches Teilen/Empfehlen auf Instagram, Facebook, TikTok oder YouTube → bis zu 5 Freiminuten je Plattform</li>
          <li>👥 Aktive Weiterempfehlung, die zu einem Erstgespräch führt → bis zu 20 Freiminuten</li>
          <li>🎥 Video-Testimonial (mind. 30 Sek., öffentlich) → bis zu 30 Freiminuten</li>
        </ul>
        <p>Der konkrete Umfang der Freiminuten wird vor der Sitzung schriftlich vereinbart. Es wird kein bestimmter Heilerfolg geschuldet.</p>

        <h3>3. Zahlungsarten</h3>
        <p>Die Bezahlung erfolgt nach der Sitzung per: Kreditkarte (Visa/Mastercard), PayPal, EC-Sofortüberweisung oder Banküberweisung (Vorkasse). Rechnungen werden per E-Mail zugestellt und sind sofort fällig.</p>

        <h3>4. Gratis-Erstgespräch</h3>
        <p>Das erste Kennenlerngespräch (bis 30 Minuten) ist kostenfrei und unverbindlich. Es findet per Video oder Telefon statt und dient ausschließlich der gegenseitigen Vorstellung und Klärung des Anliegens.</p>

        <h3>5. Termine, Absagen &amp; Stornierung</h3>
        <p>Termine können bis zu <strong>24 Stunden vor Sitzungsbeginn</strong> kostenlos storniert oder verschoben werden. Bei Absage in weniger als 24 Stunden oder Nichterscheinen ohne Abmeldung wird ein Ausfallhonorar von <strong>50 % der vereinbarten Vergütung</strong> in Rechnung gestellt. Der Anbieter behält sich vor, Termine bei eigenem Ausfall kostenlos umzubuchen.</p>

        <h3>6. Abgrenzung zur Schulmedizin</h3>
        <p>Die Angebote ersetzen ausdrücklich keine medizinische, tiermedizinische, psychotherapeutische oder heilpraktische Diagnose und Behandlung. Bei ernsthaften gesundheitlichen Beschwerden ist stets eine Ärztin oder ein Arzt aufzusuchen.</p>

        <h3>7. Haftung</h3>
        <p>Eine Haftung des Anbieters für Schäden, die nicht auf grober Fahrlässigkeit oder Vorsatz beruhen, ist ausgeschlossen.</p>

        <h3>8. Schlussbestimmungen</h3>
        <p>Es gilt deutsches Recht. Gerichtsstand ist Wuppertal. Sollten einzelne Klauseln unwirksam sein, bleibt der Rest des Vertrages davon unberührt.</p>
        <p style="margin-top:1.2rem;font-size:0.8rem;color:#6b7280;">Stand: Juli 2026 · pranapaw, Kevin Maus, Wuppertal</p>
      `
    },
    datenschutz: {
      ...
      html: `
        ...
        <p>Kevin Maus · pranapaw<br>Theoderichstraße 38 · 42281 Wuppertal<br>E-Mail: <a href="mailto:info@pranapaw.net">info@pranapaw.net</a></p>
        <p>Wir nehmen den Schutz Deiner personenbezogenen Daten ernst und behandeln sie gemäß der DSGVO sowie dem BDSG.</p>

        <h3>2. Hosting – Cloudflare Pages</h3>
        <p>Diese Website wird über <strong>Cloudflare Pages</strong> (Cloudflare, Inc., 101 Townsend St., San Francisco, CA 94107, USA) gehostet. Cloudflare verarbeitet technisch erforderliche Zugriffsdaten (IP-Adresse, Zeitstempel, aufgerufene Seite) in unserem Auftrag. Ein AVV ist mit Cloudflare geschlossen. Weitere Informationen: <a href="https://www.cloudflare.com/de-de/privacypolicy/" target="_blank" rel="noopener noreferrer">Cloudflare Datenschutzrichtlinie</a>.</p>

        <h3>3. Kontaktformular – Web3Forms</h3>
        <p>Das Kontaktformular nutzt den Dienst <strong>Web3Forms</strong> (web3forms.com) zur sicheren Übertragung Deiner Nachricht. Daten werden ausschließlich zur Bearbeitung Deiner Anfrage verwendet. Es gilt die <a href="https://web3forms.com/privacy" target="_blank" rel="noopener noreferrer">Web3Forms Datenschutzrichtlinie</a>.</p>

        <h3>4. Newsletter – Brevo</h3>
        <p>Bei Newsletter-Anmeldung übermittelst Du Vornamen und E-Mail-Adresse an <strong>Brevo</strong> (Sendinblue SAS, 55 rue d'Amsterdam, 75008 Paris, Frankreich), einem EU-konformen Dienst mit integriertem AVV. Die Anmeldung erfolgt per <strong>Double-Opt-In</strong>. Abmeldung jederzeit über den Abmeldelink oder per E-Mail an info@pranapaw.net. Rechtsgrundlage: Art. 6 Abs. 1 lit. a DSGVO. <a href="https://www.brevo.com/de/legal/privacypolicy/" target="_blank" rel="noopener noreferrer">Brevo Datenschutzrichtlinie</a>.</p>

        <h3>5. WhatsApp</h3>
        <p>Beim Öffnen des WhatsApp-Links gelten die Datenschutzbedingungen von WhatsApp (Meta Platforms, Inc.). Nutze diesen Kontaktweg nur, wenn Du damit einverstanden bist.</p>

        <h3>6. Deine Rechte</h3>
        <p>Du hast das Recht auf Auskunft (Art. 15 DSGVO), Berichtigung (Art. 16), Löschung (Art. 17), Einschränkung (Art. 18), Datenübertragbarkeit (Art. 20) und Widerspruch (Art. 21). Beschwerden: <a href="https://www.ldi.nrw.de" target="_blank" rel="noopener noreferrer">LDI NRW</a>.</p>
        <p style="margin-top:1.2rem;font-size:0.8rem;color:#6b7280;">Stand: Juli 2026 · pranapaw, Kevin Maus, Wuppertal</p>
      `
    },
    impressum: {
      ...
      html: `
        ...
        <p>
          Kevin Maus<br>
          pranapaw<br>
          Theoderichstraße 38<br>
          42281 Wuppertal<br>
          Nordrhein-Westfalen, Deutschland
        </p>

        <h3>Kontakt</h3>
        <p>E-Mail: <a href="mailto:info@pranapaw.net">info@pranapaw.net</a></p>
        ...
        <p>Kevin Maus, Theoderichstraße 38, 42281 Wuppertal</p>
        ...
        <p style="margin-top:1.2rem;font-size:0.8rem;color:#6b7280;">Stand: Juli 2026</p>
      `
    }
  };
  ...
  const blogPosts = {
    "was-ist-pranaheilung": {
      ...
      html: `
        ...
        <audio class="podcast-player" controls preload="metadata" style="width: 100%; margin-bottom: 1.5rem; border-radius: 0.9rem; filter: drop-shadow(0 8px 14px rgba(21, 75, 65, 0.08));">
          <source src="Was_ist_Pranaheilung.mp3" type="audio/mpeg">
          Dein Browser unterstützt die Audiowiedergabe nicht.
        </audio>
        <p><strong>Willkommen bei Pranapaw.net – Deiner Plattform für ganzheitliche Begleitung von Mensch & Tier! 🐾❤️</strong></p>
        <p>
          In unserer neuen Podcast-Folge fragen wir: Was ist Pranaheilung überhaupt? Was ist der Unterschied von Reiki zur Pranaheilung?
        </p>
        <p>
          Warum es wichtig ist, seinen "Inneren Garten des Lebens" ebenso zu pflegen wie seinen physischen Körper. Erfahre, wie berührungslose Energiearbeit hilft, Blockaden zu lösen, deinen Energiekörper zu reinigen und deine Selbstheilungskräfte zu aktivieren.
        </p>
        <p>
          👉 Jetzt Folge hören & den inneren Garten aufräumen! Gerne auch folgen, abonnieren und weiterempfehlen!
        </p>
      `
    },
    podcast: {
    ...
    dankbarkeit: {
      ...
      html: `
        ...
        <audio class="podcast-player" controls preload="metadata" style="width: 100%; margin-bottom: 1.5rem; border-radius: 0.9rem; filter: drop-shadow(0 8px 14px rgba(21, 75, 65, 0.08));">
          <source src="podcast-dankbarkeit.mp3" type="audio/mpeg">
          Dein Browser unterstützt die Audiowiedergabe nicht.
        </audio>
    ...
    "tagesimpuls-herzsprache": {
      title: "Die heilende Kraft des Prana",
      html: `
        <p><strong>Wie Lebensenergie dein Wohlbefinden und das deiner Tiere stärkt.</strong></p>
        <p>
          Prana, auch bekannt als Qi, Chi oder Lebensenergie, ist die fundamentale Kraft, die jedes Lebewesen durchströmt. In der Pranaheilung arbeiten wir im feinstofflichen Bereich – dem Energiekörper (Aura) und den Energiezentren (Chakren). 
        </p>
        <p>
          Ohne den physischen Körper zu berühren, können wir Blockaden, gestaute Energien oder energetische Erschöpfung wahrnehmen und ausgleichen. Dies gilt für Menschen ebenso wie für Tiere. Wenn das Prana frei und harmonisch fließen kann, werden die körpereigenen Selbstheilungskräfte maximal aktiviert.
        </p>
        <h3>Lebensenergie im Alltag wahrnehmen</h3>
        <p>
          Heute möchten wir dich einladen, diese Energie bewusst wahrzunehmen. Setze dich für einen Moment aufrecht hin. Atme tief ein und stelle dir vor, wie mit der Luft helles, glitzerndes Licht – reines Prana – in jede Zelle deines Körpers strömt. Atme aus und lass alles Verbrauchte, alle Sorgen des Tages los. Du bist ein Wesen aus Licht und Energie, und dieses Feld ist jederzeit bereit, sich zu regenerieren.
        </p>
      `
    },
    "zitat-lehrer": {
      title: "Energie folgt der Aufmerksamkeit",
      html: `
        <p><strong>Die lenkende Kraft deines Fokus.</strong></p>
        <p>
          Grandmaster Choa Kok Sui, der Begründer der modernen Pranaheilung, prägte den universellen Satz: <em>"Energie folgt der Aufmerksamkeit."</em>
        </p>
        <p>
          Dieser scheinbar einfache Satz birgt eine tiefe Wahrheit für unseren Alltag. Wenn wir uns ständig Sorgen machen, uns auf Krankheiten, Ängste oder negative Erlebnisse konzentrieren, senden wir unsere wertvolle Lebensenergie genau dorthin und nähren diese Zustände.
        </p>
        <h3>Deinen Fokus heilsam ausrichten</h3>
        <p>
          Richten wir unsere Aufmerksamkeit hingegen auf Heilung, Dankbarkeit, Frieden und Liebe, fließt unser Prana in diese positiven Kanäle und stärkt uns. Das gilt auch für unsere Tiere: Sie spüren unsere Gedanken und unsere energetische Ausrichtung sofort. Indem wir lernen, unsere Aufmerksamkeit bewusst zu lenken, werden wir zu aktiven Gestaltern unserer eigenen Gesundheit und des Wohlbefindens unserer Tiere.
        </p>
      `
    },
    "meditation-herzbruecke": {
      title: "Prana-Atmung zur Aura-Reinigung",
      html: `
        <p><strong>Eine 3-Minuten-Visualisierung zur energetischen Klärung.</strong></p>
        <p>
          Diese Meditation hilft dir, deinen Energiekörper schnell zu reinigen und frisches Prana aufzunehmen. Du kannst sie allein machen oder während dein Tier in deiner Nähe ruht.
        </p>
        <h3>Anleitung:</h3>
        <ol>
          <li>Setze dich bequem und aufrecht hin. Schließe deine Augen und nimm ein paar tiefe Atemzüge.</li>
          <li>Lege deine Zunge sanft an den oberen Gaumen (dies verbindet den vorderen und hinteren Hauptenergiekanal).</li>
          <li>Atme nun im Rhythmus 6-3-6-3: Atme 6 Sekunden lang tief ein, halte den Atem für 3 Sekunden, atme 6 Sekunden lang vollständig aus, und halte die Leere für 3 Sekunden.</li>
          <li>Visualisiere beim Einatmen, wie weiß-goldenes Licht aus dem Kosmos über deinen Scheitel in dich einströmt und dich mit frischer Energie auflädt.</li>
          <li>Visualisiere beim Ausatmen, wie graue, verbrauchte Energie als feiner Dunst aus deinen Poren entweicht und im Boden neutralisiert wird.</li>
        </ol>
        <p>Wiederhole diesen Zyklus für 3 bis 5 Minuten. Du wirst spüren, wie dein Geist klarer und dein Körper vitaler wird.</p>
      `
    },
    "gedanke-schnurren": {
      title: "Die unsichtbaren Hände der Liebe",
      html: `
        <p><strong>Wie Fernheilung und energetische Verbindung räumliche Grenzen auflösen.</strong></p>
        <p>
          Manchmal fragen uns Menschen: <em>"Wie kann Pranaheilung über die Ferne funktionieren?"</em>
        </p>
        <p>
          Unsere Antwort darauf ist einfach: Energie kennt keine räumlichen Grenzen. Wenn du an ein geliebtes Tier denkst, das in einem anderen Zimmer oder kilometerweit entfernt ist, spürst du eine sofortige Herzverbindung. Diese Verbindung ist real – sie ist ein Lichtkanal, über den Energie übertragen wird.
        </p>
        <h3>Die Verbundenheit spüren</h3>
        <p>
          Fernheilung ist nichts anderes als das bewusste Senden von gereinigtem, heilsamem Prana durch diesen Kanal, getragen von der stärksten Frequenz überhaupt: der Liebe. Es ist wie ein unsichtbares Streicheln der Seele, das direkt dort ankommt, wo es gebraucht wird. Es erinnert uns daran, dass wir auf energetischer Ebene niemals getrennt sind.
        </p>
      `
    }
  };
  ...
  async function prepareMail(event) {
    event.preventDefault();
    if (!form || !formStatus) return;

    const controls = [...form.querySelectorAll("input:not([type='checkbox']):not([type='hidden']), select, textarea")];
    ...
    const originalLabel = submitButton?.dataset.submitLabel || submitButton?.textContent || "Nachricht senden";
    if (submitButton) {
      submitButton.disabled = true;
      submitButton.setAttribute("aria-busy", "true");
      submitButton.textContent = "Nachricht wird übertragen …";
    }
    formStatus.textContent = "Deine Nachricht wird sicher übertragen …";
    ...
    try {
      ...
      data.set("subject", `Neue Anfrage über pranapaw.net: ${data.get("topic")}`);
      data.set("from_name", "pranapaw Website");
      ...
      if (!response.ok || result.success === false) {
        throw new Error(result.message || "Die Übertragung war nicht erfolgreich.");
      }
      form.reset();
      ...
      formStatus.textContent = "Vielen Dank! Deine Nachricht wurde verlässlich übermittelt. Wir melden uns persönlich.";
      formStatus.style.color = "#185b4c";
    } catch (error) {
      const timedOut = error instanceof DOMException && error.name === "AbortError";
      formStatus.textContent = timedOut
        ? "Die Übertragung dauert zu lange. Bitte nutze den WhatsApp-Button."
        : "Die Nachricht konnte nicht übertragen werden. Bitte nutze WhatsApp oder schreibe an info@pranapaw.net.";
      formStatus.style.color = "#8b2525";
    } finally {
  ...
  // Newsletter Form handler – Brevo API (Double-Opt-In)
  const BREVO_API_KEY = window.BREVO_API_KEY || "";
  const BREVO_LIST_ID = 3; // pranapaw Newsletter
  ...
  newsletterForm?.addEventListener("submit", async (event) => {
    ...
    // Status-Element anlegen falls noch nicht vorhanden
    let statusEl = newsletterForm.querySelector(".newsletter-status");
    if (!statusEl) {
      statusEl = document.createElement("p");
      statusEl.className = "newsletter-status";
      statusEl.style.cssText = "margin-top:.75rem;font-size:.85rem;font-weight:600;";
      newsletterForm.appendChild(statusEl);
    }

    if (!nameInput?.value.trim() || !emailInput?.value.trim() || !privacyCheck?.checked) {
      statusEl.textContent = "Bitte alle Felder ausfüllen und die Datenschutzerklärung bestätigen.";
      statusEl.style.color = "#8b2525";
      return;
    }
    ...
    try {
      const response = await fetch("https://api.brevo.com/v3/contacts", {
        ...
        body: JSON.stringify({
          ...
          attributes: { VORNAME: nameInput.value.trim() },
      ...
      if (response.ok || response.status === 204) {
        statusEl.textContent = "✅ Fast geschafft! Bitte bestätige die E-Mail, die wir dir gerade geschickt haben.";
        statusEl.style.color = "#185b4c";
        newsletterForm.reset();
      } else {
        const err = await response.json().catch(() => ({}));
        if (err.code === "duplicate_parameter") {
          statusEl.textContent = "Du bist bereits in unserem Verteiler – danke! 💚";
          statusEl.style.color = "#185b4c";
          newsletterForm.reset();
        } else {
      ...
      statusEl.textContent = "Anmeldung fehlgeschlagen. Bitte schreib uns direkt an info@pranapaw.net.";
      statusEl.style.color = "#8b2525";
    } finally {
      btn.disabled = false;
  ...
  // 1. Tab-Umschaltung (Impuls des Tages & Medien-Archiv)
  document.querySelectorAll(".tab-trigger").forEach((trigger) => {
    trigger.addEventListener("click", () => {
      const parent = trigger.closest("section");
      if (!parent) return;

      const collapsibleContent = parent.querySelector(".blog-tab-content--collapsible");
      const isCollapsible = collapsibleContent !== null;
      ...
      if (isCollapsible && wasActive) {
        ...
        if (isCollapsible && collapsibleContent) {
  ...
  // --- Podcast Archive Interaction ---
  const archiveCards = document.querySelectorAll(".archive-card");
  
  // Global rule: only one audio can play at a time on the page
  ...
  archiveCards.forEach((card) => {
    const audio = card.querySelector(".podcast-player");
    
    // Expand or collapse card on click
    card.addEventListener("click", (e) => {
      // Check if the user clicked on an interactive element (player controls, buttons, or links)
      const isInteractive = e.target.closest("audio, button, a, .podcast-player");
      
      if (card.classList.contains("is-active")) {
        if (!isInteractive) {
          // Collapse card if clicking on it while active
  ...
  // Scroll Reveal Animation (Reveal on Scroll with Overshoot/Swing effect)
  ...
  document.querySelectorAll(".glass-card, .service-card, .archive-card, .step-item, .faq-item, .floating-note, .newsletter-card").forEach((el) => {
